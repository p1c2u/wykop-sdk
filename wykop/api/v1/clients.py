...
class BaseWykopAPIv1(BaseWykopAPI):
    """Base Wykop API version 1."""
...
class RotatingKeysWykopAPI(WykopAPIv1):
    """
    ...
    def _create_keys_iterator(self, *key_pairs):
